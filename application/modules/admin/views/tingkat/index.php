<div class="wt-dashboardbox wt-dashboardinvocies">
    <div class="wt-dashboardboxtitle wt-titlewithsearch"><h2>Kompetensi Tentor</h2>
        ...
        <a style="float: right; padding: 0 17px;" href="<?= base_url('admin/tingkat/add'); ?>" class="ml-3 wt-btn"><i class="fas fa-plus"></i> Tambah</a>
        ...
        <table class="wt-tablecategories">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="bt-content"><?= $row->nama_tingkat; ?></span></td>
