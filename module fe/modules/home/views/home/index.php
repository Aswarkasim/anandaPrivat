						...
						<div class="wt-categoryexpl">
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-01.png" alt="image description"></figure>
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-08.png" alt="image description"></figure>
									<div class="wt-cattitle">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-02.png" alt="image description"></figure>
									<div class="wt-cattitle">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-03.png" alt="image description"></figure>
									<div class="wt-cattitle">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-04.png" alt="image description"></figure>
									<div class="wt-cattitle">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-05.png" alt="image description"></figure>
									<div class="wt-cattitle">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-06.png" alt="image description"></figure>
									<div class="wt-cattitle">
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left">
								<div class="wt-categorycontent">
									<figure><img src="<?= base_url('assets/')  ?>images/categories/img-07.png" alt="image description"></figure>
									<div class="wt-cattitle">
