<main id="wt-main" class="wt-haslayout wt-innerbgcolor">
				<!-- User Profile Start-->
				<div class="wt-main-section wt-paddingtopnull wt-haslayout">
					<div class="container">
						<div class="row">	
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 float-left">
								<div style="margin-top: 0px;" class="wt-userprofileholder">
										...
										<div class="row">
											<div class="wt-proposalhead wt-userdetails">
												...
												<div class="wt-description" data-readmore="" aria-expanded="false" id="rmjs-1" style="max-height: none; height: 230px;">
													...
													<p>Excepteur sint occaecat cupidatat non proident, saeunt in culpa qui officia deserunt mollit anim id est laborum. Seden utem perspiciatis undesieu omnis iste natus error sit voluptatem.</p>
													<p>Accusantium doque laudantium, totam rem aiam eaqueiu ipsa quae ab illoion inventore veritatisetm quasitea architecto beataea dictaed quia couuntur magni dolores eos quist ratione vtatem seque nesnt. Neque porro quamest quioremas ipsum quiatem dolor sitem amet conctetur adipisci velit sedate quianon.</p>
												</div><a class="wt-btntext" href="#" data-readmore-toggle="rmjs-1" aria-controls="rmjs-1">Read More</a>
											</div>
											<div id="wt-statistics" class="wt-statistics wt-profilecounter">
												<div class="wt-statisticcontent wt-countercolor1">
													<h3 data-from="0" data-to="03" data-speed="800" data-refresh-interval="03">3</h3>
													<h4>Ongoing <br>Projects</h4>
												</div>
												<div class="wt-statisticcontent wt-countercolor2">
													<h3 data-from="0" data-to="1503" data-speed="8000" data-refresh-interval="100">1,503</h3>
													<h4>Completed <br>Projects</h4>
												</div>
												<div class="wt-statisticcontent wt-countercolor4">
													<h3 data-from="0" data-to="02" data-speed="800" data-refresh-interval="02">2</h3>
										...
										<div id="wt-ourskill" class="wt-widget">
											...
											<div class="wt-widgetcontent wt-skillscontent">
												<div class="wt-skillholder" data-percent="90%">
													...
													<div class="wt-skillbarholder"><div class="wt-skillbar" style="width: 90%;"></div></div>
												</div>
												<div class="wt-skillholder" data-percent="55%">
													<span>Website Design <em>55%</em></span>
													<div class="wt-skillbarholder"><div class="wt-skillbar" style="width: 55%;"></div></div>
												</div>
												<div class="wt-skillholder" data-percent="99%">
													<span>HTML 5 <em>99%</em></span>
													<div class="wt-skillbarholder"><div class="wt-skillbar" style="width: 99%;"></div></div>
												</div>
												<div class="wt-skillholder" data-percent="80%">
													<span>Graphic Design <em>80%</em></span>
													<div class="wt-skillbarholder"><div class="wt-skillbar" style="width: 80%;"></div></div>
												</div>
												<div class="wt-skillholder" data-percent="75%">
													<span>WordPress <em>75%</em></span>
													<div class="wt-skillbarholder"><div class="wt-skillbar" style="width: 75%;"></div></div>
												</div>
												<div class="wt-skillholder" data-percent="35%">
													<span>SEO <em>35%</em></span>
													<div class="wt-skillbarholder"><div class="wt-skillbar" style="width: 35%;"></div></div>
												</div>
												<div class="wt-skillholder" data-percent="40%">
													<span>My SQL <em>40%</em></span>
													<div class="wt-skillbarholder"><div class="wt-skillbar" style="width: 40%;"></div></div>
												</div>
												<div class="wt-skillholder" data-percent="80%">
